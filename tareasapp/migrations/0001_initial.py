...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tareasapp_categoria', (
            ...
            ('nombra', self.gf('django.db.models.fields.CharField')(max_length=64)),
    ...
    models = {
        ...
        'tareasapp.categoria': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombra': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'})
        },
        'tareasapp.tarea': {
            'Meta': {'object_name': 'Tarea'},
            'categoria': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tareasapp.Categoria']", 'null': 'True', 'blank': 'True'}),
            'descripcion': ('django.db.models.fields.TextField', [], {}),
            'estado': ('django.db.models.fields.CharField', [], {'default': "u'P'", 'max_length': '1'}),
            'fecha_creacion': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'fecha_limite': ('django.db.models.fields.DateTimeField', [], {}),
            'fecha_realizacion': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'}),
            'titulo': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'usuario': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        }
    }

    complete_apps = ['tareasapp']